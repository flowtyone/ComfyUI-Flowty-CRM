...
class Visualizer {
    constructor(node, container, visualSrc) {
        ...
        this.iframe.src = "/extensions/ComfyUI-Flowty-CRM/html/" + visualSrc + ".html"
...
app.registerExtension({
    ...
    async beforeRegisterNodeDef(nodeType, nodeData, app) {
        registerVisualizer(nodeType, nodeData, "CRMViewer", "threeVisualizer")
    },
})